...
<body>
    <div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            <div class="logo">
                <h4 class="text-light font-weight-bold mb-0">Reportes Jefe</h4>
            </div>
            <div class="menu">
                ...
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                      ...
                      <a class="dropdown-item" href="../html/loginPrincipal.html">Cerrar sesion</a>
                    </div>
                  </li>
                </ul>
              </div>
                  ...
                  <div class="container">
                      <div class="row">
                          <div class="col-lg-9 col-md-8">
                            <h1 class="font-weight-bold mb-0">Bienvenido: Reportes Mensuales Administrador Jefe 2020 </h1>
                            <p class="lead text-muted">Ultima informacion</p>
                          </div>
                        ...
                        <div class="card-body">
                          <div class="card-header bg-light">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-6 d-flex my-8">
								   <div class="mx-auto">
								        <h6 class="text-muted">Nuevo sistema para departamento finanzas</h6>
                                ...
                                <div class="col-lg-5 col-md-6 d-flex my-8">
								 <div class="mx-auto">
										<h6 class="text-muted">Cambio equipo para administradores</h6>
									    <h3 class="font-weight-bold">$250 000</h3>
										<h6 class="text-success"><i class="icon ion-md-arrow-dropup-circle"></i> Rechazado</h6>
									</div>
                                </div>
                          ...
                          <div class="card-header bg-light">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-6 d-flex my-3">
									 <div class="mx-auto">
										<h6 class="text-muted">Cambio equipo para administradores</h6>
									    <h3 class="font-weight-bold">$125 000</h3>
										<h6 class="text-success"><i class="icon ion-md-arrow-dropup-circle"></i> Rechazado</h6>
									</div>
                                </div>
                            </div>
